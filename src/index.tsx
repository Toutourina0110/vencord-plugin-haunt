...
export const settings = definePluginSettings({
    ...
    corsProxyUrl: {
        ...
        description: "haunt.gg sends no CORS headers, so in the extension the lookup has to be relayed. Point this at a proxy you control — see the README. Not needed on the userscript.",
        default: "",
        placeholder: "https://haunt-proxy.you.workers.dev",
        // The userscript goes through GM_fetch, which is not bound by CORS, so the
        // setting would only be noise there.
        hidden: () => IS_USERSCRIPT,
